package com.wiltech.timer.timer.service.impl;
...
import com.wiltech.timer.timer.component.JobScheduleCreator;
import com.wiltech.timer.timer.entity.SchedulerJobInfo;
import com.wiltech.timer.timer.repository.SchedulerRepository;
 ...
 * Implement schedule jobs, update schedules, remove, pause, stop etc. These functions are provided by quartz scheduler and we can use them if we are using the JDBC jobs store.
 */
@Slf4j
@Transactional
@Service
